...
class TestUserAPI:
    ...
    def test_get_scores(self, client):
        ...
        with open('test_requests/test_request.json', 'r') as f:
    ...
    def test_get_scores_list(self, client):
        # Load the JSON data from a file
        with open('test_requests/test_req2.json', 'r') as f:
            search_request = json.load(f)
        response = client.post("/search", json=search_request)
        print(response.json())
    ...
    def test_get_scores_tuple(self, client):
        # Load the JSON data from a file
        with open('test_requests/test_req3.json', 'r') as f:
            search_request = json.load(f)
        response = client.post("/search", json=search_request)
        print(response.json())
    ...
    def test_get_scores_range(self, client):
        # Load the JSON data from a file
        with open('test_requests/test_req4.json', 'r') as f:
            search_request = json.load(f)
        response = client.post("/search", json=search_request)
        print(response.json())
    ...
    def test_get_scores_kwargs(self, client):
        # Load the JSON data from a file
        with open('test_requests/test_req_kwargs.json', 'r') as f:
            search_request = json.load(f)
        response = client.post("/search", json=search_request)
        print(response.json())
    ...
    def test_filter(self, client):
        # Load the JSON data from a file
        with open('test_requests/test_retrieve.json', 'r') as f:
            search_request = json.load(f)
